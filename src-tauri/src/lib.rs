...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            log::info!(
                "Nextvestment Transfer starting up: version={}, platform={}-{}",
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            credentials::identity_center::start_identity_center_login,
            credentials::identity_center::open_identity_center_login,
            credentials::identity_center::poll_identity_center_login,
            credentials::identity_center::list_identity_center_accounts,
            credentials::identity_center::list_identity_center_roles,
            credentials::identity_center::save_identity_center_profile,
            credentials::identity_center::cancel_identity_center_login,
            credentials::identity_center::sign_out_identity_center,
            // Bucket commands
