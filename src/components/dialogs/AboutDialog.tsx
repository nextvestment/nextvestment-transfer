...
export default function AboutDialog({ open, onClose }: AboutDialogProps) {
  ...
  return (
    <BaseDialog 
      open={open} 
      onClose={onClose} 
      title="About Nextvestment Transfer"
      maxWidth="xs"
    >
      <Box sx={{ textAlign: 'center', pb: 2 }}>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'center', mb: 3 }}>
          ...
          >
            <Image src="/logo.png" alt="Nextvestment Transfer" width={72} height={72} style={{ objectFit: 'contain' }} />
          </Box>
        </Box>
        
        <Typography variant="h3" sx={{ fontSize: '1.5rem', mb: 0.5 }}>Nextvestment Transfer</Typography>
        ...
        <Typography variant="body2" color="text.secondary" sx={{ mb: 4, lineHeight: 1.7, fontWeight: 500 }}>
          Project file transfer for Nextvestment. Based on Brows3, the open-source Amazon S3 desktop client by rgcsekaraa, under the MIT License.
        </Typography>
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
          ...
          >
            ...
            Brows3 upstream source and license
          </Link>
          <Link 
