...
export default function AppShell({ children }: AppShellProps) {
  ...
  // Preload once the client is mounted.
  useEffect(() => {
              ...
              <Box sx={{ 
                ...
                <Box sx={{ 
                  ...
                  <Typography variant="body1" color="text.secondary" sx={{ mb: 4, lineHeight: 1.6 }}>
                    Connect your existing AWS profile, then enter the bucket, region and folder supplied for your Project Share. Use the same folder on your computer and VDI.
                  </Typography>
