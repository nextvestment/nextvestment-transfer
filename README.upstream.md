> **Historical upstream reference:** This is the original Brows3 documentation, retained for attribution. Its release links, updater, signing, funding and package-manager instructions describe upstream Brows3 and do not establish capabilities or releases of Nextvestment Transfer. Use [README.md](README.md) and this fork's docs for current behavior.
